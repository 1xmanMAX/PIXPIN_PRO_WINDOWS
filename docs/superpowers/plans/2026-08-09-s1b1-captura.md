...
- [x] **Step 1: Escribir el test de capas que falla**
...
- [x] **Step 2: Crear el esqueleto del crate**
...
- [x] **Step 3: Escribir los tests de la decisión que fallan**
...
- [x] **Step 4: Ejecutar y comprobar que falla**
...
- [x] **Step 7: Escribir el guardián del baseline que falla**
...
- [x] **Step 8: Crear `.cargo/config.toml`**
...
- [x] **Step 9: Comprobar el workspace y confirmar**
...
- [x] **Step 1: Escribir los tests del ajuste que fallan**
...
- [x] **Step 3: Implementar el ajuste**
...
- [x] **Step 5: Escribir el test de los hechos reales que falla**
...
- [x] **Step 7: Implementar la recogida**
...
mod pruebas {
    ...
    fn recortar_al_escritorio_deja_fuera_lo_que_sobresale() {
        ...
        // Corregido durante la ejecucion: el rectangulo va de x=-3000 a
        // x=-1000 y el escritorio empieza en -1920, asi que queda un ancho
        // de 920. El plan esperaba 1080, que es el trozo descartado.
        assert_eq!(recortado, Rect { x: -1920, y: 0, ancho: 920, alto: 100 });
    }
...
- [x] **Step 4: Implementar la codificación**
...
- [x] **Step 5: Implementar la bajada a CPU**
...
- [x] **Step 7: Comprobar el workspace y confirmar**
...
- [x] **Step 1: Añadir dependencias y textos**
...
- [x] **Step 4b: Decidir el nivel al arrancar y precalentar el dispositivo**
...
- [x] **Step 6: Comprobación manual de extremo a extremo**
...
- [x] El test de capas sigue pasando con las dependencias nuevas
- [x] Los catálogos de idioma siguen sincronizados
- [ ] `Ctrl+Alt+X` produce un PNG correcto —sin inclinación, con los colores buenos— y lo deja pegable en Paint del derecho *(todo verificado salvo el pegado en Paint, que queda para el ojo del usuario)*
- [x] El modo portable guarda las capturas junto al ejecutable
- [x] Las métricas del Step 7 están anotadas con sus valores reales y guardadas en `medidas/`
- [x] El log de arranque registra hechos, nivel y razones; con `nivel = "ligero"` forzado sale `ForzadoPorAjuste`
- [x] `.cargo/config.toml` fija `target-cpu=x86-64` y el guardián `baseline.rs` está en verde
